...
<head>
    ...
    <title><?php if($setting->setting_firm_info->firm_nick_name != "") echo $setting->setting_firm_info->firm_nick_name; else echo $setting->setting_firm_info->firm_name; ?> | Work</title>
    <!-- Css Section Start -->
...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed text-sm accent-navy pace-red">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="work-type" name="work-type" placeholder="Work">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <a href="assets/admin/work-type/default.xlsx" target="_blank" class="btn btn-warning btn-md btn-work-type"><i class="fa fa-eye fa-sm"></i> Format</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="dist/js/admin/work-type.js"></script>
    <!-- Js Section End -->
</body>
