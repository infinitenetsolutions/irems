...
<head>
    ...
    <title><?php if($setting->setting_firm_info->firm_nick_name != "") echo $setting->setting_firm_info->firm_nick_name; else echo $setting->setting_firm_info->firm_name; ?> | Department Management</title>
    <!-- Css Section Start -->
...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed text-sm accent-navy pace-red">
                ...
                <form id="addForm" method="POST" enctype="multipart/form-data">
                    <div class="modal-content">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <select class="form-control form-control-sm" id="departmentName" name="departmentName">
                                                ...
                                                if($getCategoryData != 0):
                                                    foreach($getCategoryData as $categorydeptt):
                                                        $manage_department_info = json_decode($categorydeptt["manage_department_info"]);
                                                 ?>
                                                 <option value="<?= $categorydeptt["manage_department_id"] ?>"><?= $manage_department_info->departmentName ?></option>
                                                 <?php
                                                   endforeach;
                                                 endif;
                                                 ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-group-sm">
                                                ...
                                                <input class="form-control form-control-sm form-control form-control-sm-sm" id="designationName" name="designationName" placeholder="Designation Name">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <button type="submit" id="addButton" class="add-button btn btn-success btn-sm"><i class="fa fa-plus fa-sm"></i> Add Designation</button>
                        </div>
                    </div>
                </form>
            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <a href="assets/admin/manage-items/defaultCategory.xlsx" target="_blank" class="btn btn-warning btn-md btn-block"><i class="fa fa-eye fa-sm"></i> Format</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="dist/js/admin/manage-designation.js"></script>
    <!-- Js Section End -->
</body>
