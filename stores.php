<!-- Item Management -->
<?php $page_no = "5"; $page_no_inside = "5_9";
?>
...
<head>
    ...
    <title><?php if($setting->setting_firm_info->firm_nick_name != "") echo $setting->setting_firm_info->firm_nick_name; else echo $setting->setting_firm_info->firm_name; ?> | Stores</title>
    <!-- Css Section Start -->
...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed text-sm accent-navy pace-red">
    ...
    <script src="dist/js/admin/stores.js"></script>
    <!-- Js Section End -->
</body>
