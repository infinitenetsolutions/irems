...
<head>
    ...
    <title><?php if($setting->setting_firm_info->firm_nick_name != "") echo $setting->setting_firm_info->firm_nick_name; else echo $setting->setting_firm_info->firm_name; ?> | Manage Tickets</title>
    <!-- Css Section Start -->
...
-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Your Name">
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <a href="../assets/customer/manage-tickets/default.xlsx" target="_blank" class="btn btn-warning btn-md btn-block"><i class="fa fa-eye fa-sm"></i> Format</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="../dist/js/ajax_tickts.js"></script>
    <script src="../dist/js/customer/manage-tickets.js"></script>
    <!-- Js Section End -->
</body>
