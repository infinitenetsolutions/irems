...
<head>
    ...
    <title><?php if($setting->setting_firm_info->firm_nick_name != "") echo $setting->setting_firm_info->firm_nick_name; else echo $setting->setting_firm_info->firm_name; ?> | Customer Portal</title>
    <!-- Css Section Start -->
...
-->
                ...
                <form id="addForm" method="POST" enctype="multipart/form-data">
                    <div class="modal-content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="projectName" name="projectName" class="form-control select2 select2-navy" data-dropdown-css-class="select2-navy">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="card card-navy card-outline">
                                                        <div class="card-header">
                                                            <h3 class="card-title">Select Property</h3>
                                                        </div>
                                                        <div class="card-body table-responsive">
                                                            <div class="col-md-12" id="inner-property">
                                                                <div class="alert alert-info alert-dismissible">
                                                                  <h5><i class="icon fas fa-info"></i> Please first select Project.</h5>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="phase" name="phase" type="text" class="form-control" readonly/>
                                                        <input id="properties" name="properties" type="hidden" class="form-control" readonly/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="block">Block</label>
                                                        <input id="block" name="block" type="text" class="form-control" readonly/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="building">Building</label>
                                                        <input id="building" name="building" type="text" class="form-control" readonly/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="propertyType">Property</label>
                                                        <input id="propertyType" name="propertyType" type="text" class="form-control" readonly/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="accommodationType">Accommodation</label>
                                                        <input id="accommodationType" name="accommodationType" type="text" class="form-control" readonly/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="squareFeet">Total Area Sq.ft</label>
                                                        <input id="squareFeet" name="squareFeet" type="text" class="form-control" readonly/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="pricePerSquare" name="pricePerSquare" type="number" min="0" class="form-control" readonly />
                                                            <div class="input-group-prepend">
                                                                <button type="button" class="btn btn-danger">/ Sq.ft</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="propertyPrice" name="propertyPrice" type="number" min="0" class="form-control" readonly />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="propertyPriceDeal" name="propertyPriceDeal" type="number" min="0.00" step=any class="form-control" reaonly />
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="propertyNumber" name="propertyNumber" type="number" min="0" class="form-control" reaonly />
                                                        </div>
                                                        <small class="text-red">Flat No, Duplex No etc.</small>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="propertyCarParking">Car Parking</label>
                                                        <select id="propertyCarParkings" name="propertyCarParkings" class="form-control select2 select2-navy" data-dropdown-css-class="select2-navy">
                                                ...
                                                <div id="divCarParkingAmount" class="col-md-4 display-none">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="CarParkingAmount" name="CarParkingAmount" type="number" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="propertyScooterParking">Scooter Parking</label>
                                                        <select id="propertyScooterParkings" name="propertyScooterParkings" class="form-control select2 select2-navy" data-dropdown-css-class="select2-navy">
                                                            <option value="No">No</option>
                                                            <option value="Yes">Yes</option>
                                                        </select>
                                                    </div>
                                               ...
                                               <div id="divScooterParkingAmount" class="col-md-4 display-none">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="ScooterParkingAmount" name="ScooterParkingAmount" type="number" class="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card card-navy" id="paymentInformationDiv">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="paymentAmount">Down Payment</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <button type="button" class="btn btn-danger">&#8377;</button>
                                                            </div>
                                                            <input id="paymentAmount" name="paymentAmount" type="number" min="0" class="form-control"/>
                                                        </div>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input id="paymentAmountInRupees" name="paymentAmountInRupees" type="text" class="form-control" readonly/>
                                                            <div class="input-group-prepend">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="paymentAmountNumber" name="paymentAmountNumber" type="text" class="form-control"/>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="paymentAmountDate" name="paymentAmountDate" type="date" class="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-group mb-0">
                                                                        <div class="input-group" style="width:150px;">
                                                                            <input id="paymentStuctureCompletion1" name="paymentStuctureCompletion[]" type="number" min="0.00" step=any class="form-control " onclick="calculateAmount();" onkeyup="calculateAmount();"/>
                                                                            <div class="input-group-prepend">
                                                                                <button type="button" class="btn btn-danger">%</button>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-group mb-0">
                                                                        <div class="input-group" style="width:200px;">
                                                                            ...
                                                                            <input id="paymentStuctureAmount1" name="paymentStuctureAmount[]" type="number" min="0.00" step=any class="form-control " onclick="calculateAmount();" onkeyup="calculateAmount();" readonly/>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-group mb-0">
                                                                        <input id="paymentStuctureRemark1" name="paymentStuctureRemark[]" type="text" class="form-control " onclick="calculateAmount();" onkeyup="calculateAmount();" style="width:200px;" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <button type="button" name="add" id="add" class="btn btn-warning " onclick="calculateAmount();" onkeyup="calculateAmount();"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="form-group mb-0">
                                                                        <div class="input-group" style="width:200px;">
                                                                            <input id="ExtraAmount1" name="ExtraAmount[]" type="number" min="0.00" step=any class="form-control "/>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-group mb-0">
                                                                        <input id="ExtraAmountRemarks1" name="ExtraAmountRemarks[]" type="text" class="form-control " style="width:200px;" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <button type="button" name="extraamountadd" id="extraamountadd" class="btn btn-warning "><i class="fa fa-plus" aria-hidden="true"></i></button>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <select id="firstApplicantTitle" name="firstApplicantTitle" class="form-control select2 select2-navy" data-dropdown-css-class="select2-navy">
                                                                    <option selected value="Mr">Mr.</option>
                                                                    <option value="Mrs">Mrs.</option>
                                                                    <option value="Ms">Ms.</option>
                                                                </select>
                                                            </div>
                                                            <input id="firstApplicantName" name="firstApplicantName" type="text" class="form-control"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="firstApplicantParentOf" name="firstApplicantParentOf" type="text" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="firstApplicantUsername">Username</label>
                                                        <input id="firstApplicantUsername" name="firstApplicantUsername" type="text" min="0" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                        <input id="logPass" name="logPass" type="password" class="form-control"/>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="firstApplicantPhoneNumber" name="firstApplicantPhoneNumber" type="number" min="0" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="firstApplicantAlternatePhoneNumber">Alternate Phone Number</label>
                                                        <input id="firstApplicantAlternatePhoneNumber" name="firstApplicantAlternatePhoneNumber" type="number" min="0" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="firstApplicantAlternateFax">Fax</label>
                                                        <input id="firstApplicantAlternateFax" name="firstApplicantAlternateFax" type="number" min="0" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="firstApplicantEmailId">Email Id</label>
                                                        <input id="firstApplicantEmailId" name="firstApplicantEmailId" type="email" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="firstApplicantDateOfBirth">Date Of Birth</label>
                                                        <input id="firstApplicantDateOfBirth" name="firstApplicantDateOfBirth" type="date" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input id="firstApplicantAge" name="firstApplicantAge" type="number" class="form-control" readonly/>
                                                            <div class="input-group-prepend">
                                                                <button type="button" id="firstApplicantCalculateAge" class="btn btn-danger">Calculate</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="firstApplicantMaritalStatus" name="firstApplicantMaritalStatus" class="form-control select2 select2-navy" data-dropdown-css-class="select2-navy">
                                                ...
                                                <div id="divFirstApplicantDateOfAnniversary" class="col-md-4 display-none">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="firstApplicantDateOfAnniversary" name="firstApplicantDateOfAnniversary" type="date" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div id="divFirstApplicantNoOfChild" class="col-md-4 display-none">
                                                    <div class="form-group">
                                                        <label for="firstApplicantNoOfChild">Number Of Children</label>
                                                        <input id="firstApplicantNoOfChild" name="firstApplicantNoOfChild" type="number" min="0" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="firstApplicantReligion">Religion</label>
                                                        <input id="firstApplicantReligion" name="firstApplicantReligion" type="text" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="firstApplicantCaste">Caste</label>
                                                        <input id="firstApplicantCaste" name="firstApplicantCaste" type="text" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="firstApplicantResidentialStatus">Residential Status</label>
                                                        <select id="firstApplicantResidentialStatus" name="firstApplicantResidentialStatus" class="form-control select2 select2-navy" data-dropdown-css-class="select2-navy">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="firstApplicanOccupation" name="firstApplicanOccupation" type="text" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="firstApplicanPanNumber">PAN Number</label>
                                                        <input id="firstApplicanPanNumber" name="firstApplicanPanNumber" type="number" min="0" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="firstApplicanAadharNumber">Aadhar Number</label>
                                                        <input id="firstApplicanAadharNumber" name="firstApplicanAadharNumber" type="number" min="0" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="firstApplicanPermanentAddress">Permanent Address</label>
                                                        <textarea id="firstApplicanPermanentAddress" name="firstApplicanPermanentAddress" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="firstApplicanCorrespondenceAddress">Correspondence Address</label>
                                                        <textarea id="firstApplicanCorrespondenceAddress" name="firstApplicanCorrespondenceAddress" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <select id="secondApplicantTitle" name="secondApplicantTitle" class="form-control select2 select2-navy" data-dropdown-css-class="select2-navy">
                                                                    <option selected value="Mr">Mr.</option>
                                                                    <option value="Mrs">Mrs.</option>
                                                                    <option value="Ms">Ms.</option>
                                                                </select>
                                                            </div>
                                                            <input id="secondApplicantName" name="secondApplicantName" type="text" class="form-control"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="secondApplicantParentOf" name="secondApplicantParentOf" type="text" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="secondApplicantPhoneNumber">Phone Number</label>
                                                        <input id="secondApplicantPhoneNumber" name="secondApplicantPhoneNumber" type="number" min="0" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="secondApplicantAlternatePhoneNumber">Alternate Phone Number</label>
                                                        <input id="secondApplicantAlternatePhoneNumber" name="secondApplicantAlternatePhoneNumber" type="number" min="0" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="secondApplicantAlternateFax">Fax</label>
                                                        <input id="secondApplicantAlternateFax" name="secondApplicantAlternateFax" type="number" min="0" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="secondApplicantEmailId">Email Id</label>
                                                        <input id="secondApplicantEmailId" name="secondApplicantEmailId" type="email" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="secondApplicantDateOfBirth">Date Of Birth</label>
                                                        <input id="secondApplicantDateOfBirth" name="secondApplicantDateOfBirth" type="date" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input id="secondApplicantAge" name="secondApplicantAge" type="number" class="form-control" readonly/>
                                                            <div class="input-group-prepend">
                                                                <button type="button" id="secondApplicantCalculateAge" class="btn btn-danger">Calculate</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="secondApplicantMaritalStatus" name="secondApplicantMaritalStatus" class="form-control select2 select2-navy" data-dropdown-css-class="select2-navy">
                                                            <option selected value="Single">Single</option>
                                                            <option value="Married">Married</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div id="divSecondApplicantDateOfAnniversary" class="col-md-4 display-none">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="secondApplicantDateOfAnniversary" name="secondApplicantDateOfAnniversary" type="date" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div id="divSecondApplicantNoOfChild" class="col-md-4 display-none">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="secondApplicantNoOfChild" name="secondApplicantNoOfChild" type="number" min="0" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="secondApplicantReligion">Religion</label>
                                                        <input id="secondApplicantReligion" name="secondApplicantReligion" type="text" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="secondApplicantCaste">Caste</label>
                                                        <input id="secondApplicantCaste" name="secondApplicantCaste" type="text" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="secondApplicantResidentialStatus">Residential Status</label>
                                                        <select id="secondApplicantResidentialStatus" name="secondApplicantResidentialStatus" class="form-control select2 select2-navy" data-dropdown-css-class="select2-navy">
                                                            <option selected value="Resident">Resident</option>
                                                            <option value="Non-Resident">Non-Resident</option>
                                                            <option value="Foreign National of Indian Origin">Foreign National of Indian Origin</option>
                                                        </select>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="secondApplicanOccupation" name="secondApplicanOccupation" type="text" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="secondApplicanPanNumber">PAN Number</label>
                                                        <input id="secondApplicanPanNumber" name="secondApplicanPanNumber" type="number" min="0" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="secondApplicanAadharNumber">Aadhar Number</label>
                                                        <input id="secondApplicanAadharNumber" name="secondApplicanAadharNumber" type="number" min="0" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="secondApplicanPermanentAddress">Permanent Address</label>
                                                        <textarea id="secondApplicanPermanentAddress" name="secondApplicanPermanentAddress" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="secondApplicanCorrespondenceAddress">Correspondence Address</label>
                                                        <textarea id="secondApplicanCorrespondenceAddress" name="secondApplicanCorrespondenceAddress" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <button type="submit" id="addButton" class="add-button btn btn-success btn-sm" onClick="sendMail();"><i class="fa fa-plus fa-sm"></i> Add this</button>
                        </div>
                    </div>
                </form>
            </div>
       ...
       <!--  <div class="modal fade" id="payment-structure-payment-modal">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Payment Structure Payments</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        <!-- <div class="modal fade" id="edit-modal">
            <div class="modal-dialog modal-lg">
                <form id="editForm" method="POST" enctype="multipart/form-data">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Edit First Applicant Information</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
    ...
    <script src="../dist/js/customer/dashboard.js"></script>
     <!--<script>
        $(function(){
