...
<head>
    ...
    <title><?php if($setting->setting_firm_info->firm_nick_name != "") echo $setting->setting_firm_info->firm_nick_name; else echo $setting->setting_firm_info->firm_name; ?> | Owners</title>
    <!-- Css Section Start -->
...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed text-sm accent-navy pace-red">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" id="ownerLogo" name="ownerLogo" accept="image/*">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="ownerContactNumber" name="ownerContactNumber" placeholder="Contact Number">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="ownerOfficeNumber">Office Number</label>
                                                <input type="number" class="form-control" id="ownerOfficeNumber" name="ownerOfficeNumber" placeholder="Office Number">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="ownerWebsite">Website</label>
                                                <input type="url" class="form-control" id="ownerWebsite" name="ownerWebsite" placeholder="Website">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="ownerPanNo">Pan No</label>
                                                <input type="number" class="form-control" id="ownerPanNo" name="ownerPanNo" placeholder="Pan No">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="ownerAadharNo">Aadhar No</label>
                                                <input type="number" class="form-control" id="ownerAadharNo" name="ownerAadharNo" placeholder="Aadhar No">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="ownerGSTIN">GST IN</label>
                                                <input type="text" class="form-control" id="ownerGSTIN" name="ownerGSTIN" placeholder="GST IN">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="ownerState">State</label>
                                                <select class="form-control select2" id="ownerState" name="ownerState">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" id="ownerCity" name="ownerCity">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="ownerPincode">Pincode</label>
                                                <input type="text" class="form-control" id="ownerPincode" name="ownerPincode" placeholder="Pincode">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="ownerAddress">Address</label>
                                                <textarea class="form-control" id="ownerAddress" name="ownerAddress" placeholder="Address"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <a href="assets/admin/land-acquisition-owners/default.xlsx" target="_blank" class="btn btn-warning btn-md btn-block"><i class="fa fa-eye fa-sm"></i> Format</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="dist/js/admin/land-acquisition-owners.js"></script>
    <!-- Js Section End -->
</body>
