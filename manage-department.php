...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed text-sm accent-navy pace-red">
                ...
                <form id="addForm" method="POST" enctype="multipart/form-data">
                    <div class="modal-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="departmentName" name="departmentName" placeholder="Department Name">
                                            </div>
                                        </div>
                                        <!-- <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="designationName">Designation Name</label>
                                                <input class="form-control form-control-sm" id="designationName" name="designationName" placeholder="Designation Name">
                                            </div>
                                        </div> -->
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <button type="submit" id="addButton" class="add-button btn btn-success btn-sm"><i class="fa fa-plus fa-sm"></i> Add Department</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script src="dist/js/admin/manage-department.js"></script>
    <!-- Js Section End -->
</body>
