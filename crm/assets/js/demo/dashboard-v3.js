    ...
    var options = {
        ...
        fill: {
            ...
            gradient: {
                ...
                opacityTo: 1,
                colorStops: [
                    { offset: 0, color: COLOR_BLUE, opacity: 1 },
                    { offset: 100, color: COLOR_INDIGO, opacity: 1 },
                ],
            },
        },
        ...
        responsive: [
            { breakpoint: 1500, options: { chart: { width: 130 } } },
    ...
    var options = {
        ...
        fill: {
            ...
            gradient: {
                ...
                opacityTo: 1,
                colorStops: [
                    { offset: 0, color: COLOR_RED, opacity: 1 },
                    { offset: 50, color: COLOR_ORANGE, opacity: 1 },
                    { offset: 100, color: COLOR_LIME, opacity: 1 },
                ],
            },
        },
        ...
        responsive: [
            { breakpoint: 1500, options: { chart: { width: 120 } } },
            { breakpoint: 1300, options: { chart: { width: 100 } } },
    ...
    var options = {
        ...
        fill: {
            ...
            gradient: {
                ...
                opacityTo: 1,
                colorStops: [
                    { offset: 0, color: COLOR_TEAL, opacity: 1 },
                    { offset: 50, color: COLOR_BLUE, opacity: 1 },
                    { offset: 100, color: COLOR_AQUA, opacity: 1 },
                ],
            },
        },
...
var handleVisitorsMap = function () {
    var options = {
        ...
        regionStyle: { initial: { fill: COLOR_DARK_LIGHTER, "fill-opacity": 1, stroke: "none", "stroke-width": 0.4, "stroke-opacity": 1 }, hover: { "fill-opacity": 0.8 }, selected: { fill: "yellow" } },
        series: { regions: [{ values: { IN: COLOR_TEAL, US: COLOR_TEAL, MN: COLOR_TEAL, RU: COLOR_TEAL } }] },
