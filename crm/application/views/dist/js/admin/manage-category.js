$(function(){
    ...
    $('form#addForm').submit(function (event) {
        ...
        if($("#categoryDescription").val() == ""){
            ...
            $("#categoryDescription").removeClass("is-invalid");
        if(flag == 1){
            ...
            $.ajax({
                url: 'application/controller/admin/manage-category.php',
                type: 'POST',
                data: formData,
                dataType: "json",
                success: function (data) {
    ...
    $('form#editForm').submit(function (event) {
        ...
        if($("#editCategoryDesctiption").val() == ""){
            $("#editCategoryDesctiption").addClass("is-invalid");
            flag = 0;
        }else
            $("#editCategoryDesctiption").removeClass("is-invalid");
        if(flag == 1){
