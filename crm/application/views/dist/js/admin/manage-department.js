$(function(){
    ...
    $('form#addForm').submit(function (event) {
        ...
        if(flag == 1){
            ...
            $.ajax({
                url: 'application/controller/manage-department.php',
                type: 'POST',
                data: formData,
                dataType: "json",
                success: function (data) {
    ...
    $('form#importForm').submit(function (event) {
        ...
        if(flag == 1){
            ...
            $.ajax({
                url: 'application/controller/admin/property-type.php',
                type: 'POST',
                data: formData,
                dataType: "json",
                success: function (data) {
    ...
    $('form#editForm').submit(function (event) {
        ...
        var flag = 1;
        if($("#editPropertyType").val() == ""){
            $("#editPropertyType").addClass("is-invalid");
            flag = 0;
        }else
            $("#editPropertyType").removeClass("is-invalid");
        if(flag == 1){
