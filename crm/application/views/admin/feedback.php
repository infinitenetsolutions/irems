...
<h1>Feedbacks <span class="table-project-n"></span> </h1>
</div>
</div>
...
<tr>
		...
		<th data-field="Question 1" data-sortable="true">Question 1</th>
		<th data-field="Question 2" data-sortable="true">Question 2</th>
		<th data-field="Question 3" data-sortable="true">Question 3</th>
		<th data-field="Question 4" data-sortable="true">Question 4</th>
		<th data-field="Question 5" data-sortable="true">Question 5</th>
		<th data-field="Question 6" data-sortable="true">Question 6</th>
...
<tr>
		...
		<td><?php echo $row->first_answer; ?></td>
		<td><?php echo $row->second_answer	; ?></td>
		<td><?php echo $row->third_answer; ?></td>
		<td><?php echo $row->fourth_answer; ?></td>
		<td><?php echo $row->fifth_answer; ?></td>
		<td><?php echo $row->sixth_answer; ?></td>
     ...
     <td>
        ...
        <a rel="tooltip" title="Remove" class="btn btn-link btn-danger table-action remove" onClick="return confirm('Are you sure you want to delete?')" href="delete_feedback/<?php echo $row->id;?>">
