...
<?php endif; ?>
            <div class="row">
               <div class="col-xl-12">
                     ...
                     <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="form-group">
                                <select class="default-select2 form-control" name="emp_store_name" id="emp_store_name">
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <select class="default-select2 form-control" name="employee_id" id="employee_id">
                                    ...
                                    ?>
                                    <option value="<?php echo $row['id'];?>"> <?php echo $row['first_name'].' '.$row['last_name'].' ['.$row['employee_id'].']'; ?>  </option>
                                  <?php } ?>
                                  </select>
                              </div>
                          </div>
                ...
                <div class="col-md-3">
                  <button class="btn btn-success btn-sm " id="show_leave">Show Attendance Report</button>
                </div>
              </div>
