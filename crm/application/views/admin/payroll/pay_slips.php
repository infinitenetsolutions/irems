    ...
    <div class="col-xl-12">
      <div class="panel panel-inverse">
        ...
        <div class="panel-body ">
          <div class="row">
            <div class="col-md-3">
              <label class="control-label mr-2"><strong>Store Name:</strong></label>
              <select class="form-control" name="emp_store_name" id="emp_store_name">
               <option value="all" selected>All</option>
                <?php
                   foreach ($store as $Srow) {  ?>
                    <option value="<?php echo $Srow['str_id'];?>"> <?php echo $Srow['str_name']; ?> </option>
                 <?php } ?>
              </select>
            </div>
            <div class="col-md-3">
...
$("#show_payslip").click(function () {
  var store_id = $('#emp_store_name').val();
  var department_id = $('#department').val();
  var designation_id = $('#designation').val();
  var employee_id = $('#employee_id').val();
  var year = $('#year').val();
  var month = $('#month').val(); // return 2018-10-21
  if ((department_id == null) || (designation_id == null) || (employee_id == null) || (year == null) || (month == null) || (store_id == null)) {
    alert('Please Select Store, Department, Designation, Employee, Year and Month ');
  } else {
    $.ajax({
      url: "<?php echo base_url();?>Payroll/show_payslip_view/",
      method: "POST",
      data: {
        "store_id": store_id,
...
$('#designation').change(function () {
  ...
  if (design_id != '') {
    $.ajax({
      url: "<?php echo base_url(); ?>Payroll/fetch_employee_name",
      method: "POST",
      data: {
        "design_id": design_id
      },
