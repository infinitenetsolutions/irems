<!-- Item Management -->
<?php $page_no = "5"; $page_no_inside = "5_8";
?>
...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed text-sm accent-navy pace-red">
    <div id="wrapper" class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">My Stores</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="card card-navy card-outline">
                    <div class="card-header">
                        <h3 class="card-title float-right">
                            ...
                            <button id="order-button" type="button" class="order-button btn btn-sm btn-success mt-1 mb-1"  data-target="#create-indent"title="Order" disabled>
                                <i class="fa fa-cart-plus fa-sm"></i> Create Indent
                            </button>
                            <button id="commit-button" type="button" class="commit-button btn btn-sm btn-success mt-1 mb-1" data-toggle="modal" data-target="#commit-modal" title="Commit">
                                <i class="fas fa-save fa-sm"></i> Commit
                            </button>
                            
                             <!--  <button onclick="window.location.href='purchase_order';" id="add-button" type="button" class="add-button btn btn-sm btn-success mt-1 mb-1" data-toggle="modal" data-target="#add-modal" title="Add New" disabled>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                if($getCategoryData != 0):
                                                 ...
                                                 ?>
                                                 <option value="<?= $manage_category_info->categoryName ?>"><?= $manage_category_info->categoryName ?></option>
                                                 <?php
                                                   endforeach;
                                                 endif;
                                                 ?>
        ...
        <div class="modal fade" id="commit-modal">
            <div class="modal-dialog modal-sm">
                <form id="commitForm" method="POST" enctype="multipart/form-data">  
                <input type="hidden" id="nameOfATable" name="nameOfATable" value="tbl_manage_stock">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="alert alert-danger alert-dismissible">
                            ...
                            Do you want to commit data???
                        </div>
                        <!-- <div id="commit-section"></div> -->
                    </div>
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="close-button btn btn-danger btn-sm" data-dismiss="modal"><i class="fas fa-times fa-sm"></i> Close</button>
                            <button type="submit" id="commitButton" class="commit-button btn btn-warning btn-sm"><i class="fas fa-save fa-sm"></i> Commit</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="modal fade" id="delete-selected-modal">
            <div class="modal-dialog modal-sm">
                <form id="selectForm" method="POST" enctype="multipart/form-data">
                   <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Are you sure?</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    ...
    <script src="dist/js/admin/mystock.js"></script>
    <!-- Js Section End -->
</body>
