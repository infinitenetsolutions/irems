...
<head>
    ...
    <title><?php if($setting->setting_firm_info->firm_nick_name != "") echo $setting->setting_firm_info->firm_nick_name; else echo $setting->setting_firm_info->firm_name; ?> | Items</title>
    <!-- Css Section Start -->
...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed text-sm accent-navy pace-red">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select id="item-type-ab" name="item-type-ab" class="form-control select2 select2-navy" data-dropdown-css-class="select2-navy">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="item-type" name="item-type" placeholder="Item">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <a href="assets/admin/item-type/default.xlsx" target="_blank" class="btn btn-warning btn-md btn-item-type"><i class="fa fa-eye fa-sm"></i> Format</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="dist/js/admin/item-type.js"></script>
    <!-- Js Section End -->
</body>
