                            ...
                            <div class="card card-navy card-outline">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group form-group-smform-group-sm">
                                                <label for="jobType">Vendor/Payroll </label>
                                                <select class="form-control select2 select2-navy" data-dropdown-css-class="select2-navy" name="jobType" id="jobType">
...
<!--                                                <small class="text-red">Define this date after the completion of project</small>-->
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group form-group-smform-group-sm">
                                             ...
                                             <select class="form-control select2 select2-navy" data-dropdown-css-class="select2-navy" name="gender" id="gender">
...
<!--                                                <small class="text-red">Define this date after the completion of project</small>-->
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group form-group-smform-group-sm">
                                             ...
                                             <select class="form-control select2 select2-navy" data-dropdown-css-class="select2-navy" name="empStatus" id="empStatus">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group form-group-smform-group-sm">
                                               ...
                                               <select class="form-control select2 select2-navy" data-dropdown-css-class="select2-navy" name="empType" id="empType">
...
<!--                                                <small class="text-red">Define this date after the completion of project</small>-->
                                        ...
                                        <div class="col-md-3">     
                                            <div class="form-group">
                                                ...
                                                <!-- <input type="number" class="form-control form-control-sm salary" id="netSalary" name="netSalary"  onkeyup="getAmount()"  /> -->
                                                <input type="number" id="netSalary" onkeyup="getAmount()" class="form-control form-control-sm" name="netSalary">
                                            </div>
                                        </div>
                                        <div class="col-md-3">     
                                            <div class="form-group">
                                                <label for="">Basic Salary</label>
                                                <input type="number" class="form-control form-control-sm salary" id="basicSalary" name="basicSalary"  readonly/>
                                            </div>
                                        </div>
                                        <div class="col-md-3">     
                                            <div class="form-group">
                                                <label for="">HRA</label>
                                                <input type="number" class="form-control form-control-sm salary" id="hra" name="hra"   readonly />
                                            </div>
                                        </div>
                                        <div class="col-md-3">     
                                            <div class="form-group">
                                                <label for="">TA</label>
                                                <input type="number" class="form-control form-control-sm salary" id="ta" name="ta"   readonly />
                                            </div>
                                        </div>
                                        <div class="col-md-3">     
                                            <div class="form-group">
                                                <label for="">CEA</label>
                                                <input type="number" class="form-control form-control-sm salary" id="cea" name="cea"   readonly />
                                            </div>
                                        </div>
                                        <div class="col-md-3">     
                                            <div class="form-group">
                                                <label for="">SA</label>
                                                <input type="number" class="form-control form-control-sm salary" id="sa" name="sa"  readonly />
                                            </div>
                                        </div>
                                        <div class="col-md-3">     
                                            <div class="form-group">
                                                <label for="">Total salary</label>
                                                <input type="number" class="form-control form-control-sm salary" id="totalSalary" name="totalSalary" readonly />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">     
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control form-control-sm deduction" id="epf" name="epf" onkeyup="getDeduction()" readonly/>
                                            </div>
                                        </div>
                                        <div class="col-md-3">     
                                            <div class="form-group">
                                                <label for="loan">Loan</label>
                                                <input type="number" class="form-control form-control-sm deduction" id="loan" name="loan" onkeyup="getDeduction()"/>
                                            </div>
                                        </div>
                                        <div class="col-md-3">     
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">     
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="totalLeave" name="totalLeave"/>
                                            </div>
                                        </div>
                                       ...
                                       <div class="col-md-3">     
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="leaveLeft" name="leaveLeft"/>
                                            </div>
                                        </div>
                                       ...
                                       <!-- <div class="col-md-3">     
                                            <div class="form-group">
                                                <label for="overtime">Overtime Amount(per hour):</label>
                                                <input type="number" class="form-control form-control-sm" id="overtime" name="overtime" onkeyup="income()"/>
                                            </div>
                                        </div>-->
                                       <!-- <div class="col-md-3">     
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control form-control-sm" id="incentive" name="incentive" onkeyup="income()"/>
                                            </div>
                                        </div> -->
                                        <!--<div class="col-md-3">     
                                            <div class="form-group">
                                                <label for="disincentive">Disincentive</label>
                                                <input type="number" class="form-control form-control-sm" id="disincentive" name="disincentive" value="2000" readonly/>
                                            </div>
                                        </div>-->
                                        <div class="col-md-3">     
                                            <div class="form-group">
                                                <label for="conveyance">Conveyance</label>
                                                <input type="number" class="form-control form-control-sm" id="conveyance" name="conveyance" onkeyup="income()"/>
                                            </div>
                                        </div>
										<!--<div class="col-md-3">     
                                            <div class="form-group">
                                                <label for="Extraincome">Total Income</label>
                                                <input type="number" class="form-control form-control-sm" id="Extraincome" name="Extraincome" readonly />
                                            </div>
                                        </div> -->
                                        ...
                                        <div class="col-md-6">     
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control form-control-sm" id="finalSalary" name="finalSalary" readonly />
                                            </div>
                                        </div>
    ...
    {
        $("#totalDeduction").val(Number($('#epf').val())+Number($('#loan').val()));
        $("#finalSalary").val(Number($("#totalSalary").val()) - Number($('#epf').val())- Number($('#loan').val()));
    }
  ...
  function getAmount(){
    ...
    if(netsal > 0 || netsal <= 20000){
        $('#basicSalary').val(netsal*40/100);
        $('#hra').val(netsal*20/100);
        $('#ta').val(netsal*15/100);
        $('#cea').val(netsal*15/100);
        $('#sa').val(netsal*10/100);
       // $('#epf').val(netsal*12/100);
        $("#totalSalary").val(netsal);
        $("#grossSalary").val(netsal);
        $("#finalSalary").val(netsal);
      }
    else  if(netsal > 20000 || netsal <= 30000){
        $('#basicSalary').val(netsal*35/100);
        $('#hra').val(netsal*18/100);
        $('#ta').val(netsal*18/100);
        $('#cea').val(netsal*18/100);
        $('#sa').val(netsal*11/100);
       // $('#epf').val(netsal*12/100);
        $("#totalSalary").val(netsal);
        $("#grossSalary").val(netsal);
    	$("#finalSalary").val(netsal);
        }
    else  if(netsal > 30000 || netsal <= 40000){
        $('#basicSalary').val(netsal*30/100);
        $('#hra').val(netsal*15/100);
        $('#ta').val(netsal*22/100);
        $('#cea').val(netsal*22/100);
        $('#sa').val(netsal*11/100);
        //$('#epf').val(netsal*12/100);
        $("#totalSalary").val(netsal);
        $("#grossSalary").val(netsal);
        ...
        $('#basicSalary').val(netsal*25/100);
        $('#hra').val(netsal*13/100);
        $('#ta').val(netsal*25/100);
        $('#cea').val(netsal*25/100);
        $('#sa').val(netsal*12/100);
       // $('#epf').val(netsal*12/100);
        $("#totalSalary").val(netsal);
        $("#grossSalary").val(netsal);
        $("#finalSalary").val(netsal);
