...
<head>
    ...
    <title><?php if($setting->setting_firm_info->firm_nick_name != "") echo $setting->setting_firm_info->firm_nick_name; else echo $setting->setting_firm_info->firm_name; ?> | Goods Receipts</title>
    <!-- Css Section Start -->
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed text-sm accent-navy pace-red">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Goods Receipt Note(GRN)</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
   ...
   <!-- End Panel Mode Switch -->
    ...
    <script src="dist/js/admin/goods-receipt.js"></script>
    ...
    <?php
        if(isset($_GET["response"])):
            if($_GET["response"] == "success"):
                echo "<script>
                        setTimeout(function(){
                            topEndNotification('success', 'Item Received successfully!!!');
                        }, 3000);
                      </script>";
            endif;
        endif;
