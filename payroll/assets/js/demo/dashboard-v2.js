...
var handleVisitorsVectorMap = function () {
    if ($("#visitors-map").length !== 0) {
        $("#visitors-map").vectorMap({
            ...
            hoverColor: false,
            zoomOnScroll: false,
            markerStyle: { initial: { fill: COLOR_DARK, stroke: "transparent", r: 3 } },
...
var handleScheduleCalendar = function () {
    ...
    var events = [
        ["2/" + month + "/" + year, "Popover Title", "#", COLOR_GREEN, "Some contents here"],
    ...
    $(calendarTarget).calendar({ months: monthNames, days: dayNames, events: events, popover_options: { placement: "top", html: true } });
    $(calendarTarget)
        .find("td.event")
        .each(function () {
