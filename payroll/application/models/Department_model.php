...
class Department_model extends CI_Model {
	...
	public function __construct()
		...
		$this->table= 'tbl_manage_department';
		$this->primary_key='manage_department_id';
		}
	...
	public function get_department_by_id($id = 0)
    {
		if ($id === 0)
		{
		$query = $this->db->get('tbl_manage_department');
		return $query->result_array();
		}

		$query = $this->db->get_where('tbl_manage_department', array('manage_department_id' => $id));
