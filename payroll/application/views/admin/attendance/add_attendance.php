    ...
    <!-- datatable links end -->
      ...
      <script type="text/javascript">
        ...
        load_data_table();
           ...
           function calovertime(data,empId) {
           
           var overtime = document.getElementById('overtime'+empId).value; //get overtime
            var salary = document.getElementById('empSalary'+empId).value;  //get salary
             var attlastDate = document.getElementById('attlastDate'+empId).value;  //get last date of current month
              var result = (parseFloat(salary)/parseInt(attlastDate)) * parseFloat(overtime);
            // console.log(overtime);
             //console.log(salary);
            // console.log(result);
              if (!isNaN(result)) {
             document.getElementById('overtime_amount'+empId).value = result.toFixed(2);
            }

        }
        
        function statusselect(status,empid){
          //alert(status);

          if(status == "Overtime"){
            
           document.getElementById('overtime'+empid).style.display = "block";
           document.getElementById('overtime_amount'+empid).style.display = "block";
