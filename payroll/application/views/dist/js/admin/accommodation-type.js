$(function(){
    ...
    $('form#addForm').submit(function (event) {
        ...
        if(flag == 1){
            ...
            $.ajax({
                url: 'application/controller/admin/accommodation-type.php',
                type: 'POST',
                data: formData,
                dataType: "json",
                success: function (data) {
    ...
    $('form#editForm').submit(function (event) {
        ...
        var flag = 1;
        if($("#editAccommodationType").val() == ""){
            $("#editAccommodationType").addClass("is-invalid");
            flag = 0;
        }else
            $("#editAccommodationType").removeClass("is-invalid");
        if(flag == 1){
