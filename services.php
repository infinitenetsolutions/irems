...
<head>
    ...
    <title><?php if($setting->setting_firm_info->firm_nick_name != "") echo $setting->setting_firm_info->firm_nick_name; else echo $setting->setting_firm_info->firm_name; ?> | Services</title>
    <!-- Css Section Start -->
...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed text-sm accent-navy pace-red">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="servicesName" name="servicesName" placeholder="Services Name">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="renewalservicesType">Renewal Services Type </label>
                                                <input type="text" class="form-control" id="renewalservicesType" name="renewalservicesType" placeholder="Renewal Services Type ">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="daterenewalServices">Date Of Renewable Services</label>
                                                <input type="date" class="form-control" id="daterenewalServices" name="daterenewalServices" placeholder="date of Renewal Services ">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="pricesofService">Price Of Services</label>
                                                <input type="text" class="form-control" id="pricesofService" name="pricesofService" placeholder="Price Of services ">
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <a href="assets/admin/services/default.xlsx" target="_blank" class="btn btn-warning btn-md btn-block"><i class="fa fa-eye fa-sm"></i> Format</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="dist/js/admin/services.js"></script>
    <!-- Js Section End -->
</body>
