...
<head>
    ...
    <title><?php if($setting->setting_firm_info->firm_nick_name != "") echo $setting->setting_firm_info->firm_nick_name; else echo $setting->setting_firm_info->firm_name; ?> |  Manage PO</title>
    <!-- Css Section Start -->
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Manage Purchase Orders</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
...
-->
 ...
 <!-- view Payment Status Section Start -->
        <div class="modal fade" id="pay-modal">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="card card-navy card-outline">
                            <div class="card-body" id="pay-section"></div>
                        </div>
                    </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="close-button btn btn-danger btn-sm" data-dismiss="modal"><i class="fas fa-times fa-sm"></i> Close</button>
    ...
    <script src="dist/js/admin/manage-po.js"></script>
