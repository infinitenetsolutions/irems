                    ...
                    if(!empty($_POST["firstName"] )):
                        ...
                        $employee_info = array(
                                           "img"                  =>      htmlspecialchars($img, ENT_QUOTES),
                                            ...
                                            "cea"                  	=>      htmlspecialchars($_POST["cea"], ENT_QUOTES),
                                            "sa"                   	=>      htmlspecialchars($_POST["sa"], ENT_QUOTES),
                                             "total_leave"          =>      htmlspecialchars($_POST["total_leave"], ENT_QUOTES),
                                             "leave_left"           =>      htmlspecialchars($_POST["leave_left"], ENT_QUOTES),
                                            "totalSalary"          	=>      htmlspecialchars($_POST["totalSalary"], ENT_QUOTES),
                                            "netSalary"            	=>      htmlspecialchars($_POST["netSalary"], ENT_QUOTES),
                                           // "epf"            		=>      htmlspecialchars($_POST["epf"], ENT_QUOTES),
                                            //"loan"           		=>      htmlspecialchars($_POST["loan"], ENT_QUOTES),
                                           // "totalDeduction"        =>      htmlspecialchars($_POST["totalDeduction"], ENT_QUOTES),
                                            //"overtime"				=>      htmlspecialchars($_POST["overtime"], ENT_QUOTES),
                                            //"disincentive"			=>      htmlspecialchars($_POST["disincentive"], ENT_QUOTES),
                                            "conveyance"			=>      htmlspecialchars($_POST["conveyance"], ENT_QUOTES),
                                            "grossSalary"           =>      htmlspecialchars($_POST["grossSalary"], ENT_QUOTES),
                                            "finalSalary"           =>      htmlspecialchars($_POST["finalSalary"], ENT_QUOTES),
                                            "account_holder_name"  	=>      htmlspecialchars($_POST["account_holder_name"], ENT_QUOTES),                    
                                            "bankName"             	=>      htmlspecialchars($_POST["bankName"], ENT_QUOTES),                    
                                            "acc_no"              	=>      htmlspecialchars($_POST["acc_no"], ENT_QUOTES),                    
                                            "branch"              	=>      htmlspecialchars($_POST["branch"], ENT_QUOTES)                    
                        ...
                        if($getData != 0):
                            ...
                            if(!empty($_POST["editDepartment"] && $_POST["editDesignation"])):
                                ...
                                $edit_info = array(
                                                    ...
                                                    "netSalary"         	=>      htmlspecialchars($_POST["editnetSalary"], ENT_QUOTES),
                                                    "basicSalary"          =>      htmlspecialchars($_POST["editbasicSalary"], ENT_QUOTES),
                                                    "hra"                  =>      htmlspecialchars($_POST["editHra"], ENT_QUOTES),
                                                    "ta"                   =>      htmlspecialchars($_POST["editTa"], ENT_QUOTES),
                                                    "cea"                  =>      htmlspecialchars($_POST["editCea"], ENT_QUOTES),
                                                    "sa"                   =>      htmlspecialchars($_POST["editSa"], ENT_QUOTES),
                                                    "totalSalary"          =>      htmlspecialchars($_POST["edittotalSalary"], ENT_QUOTES),
                                                    "totalLeave"          =>      htmlspecialchars($_POST["edittotalLeave"], ENT_QUOTES),
                                                    "leaveLeft"           =>      htmlspecialchars($_POST["editleaveLeft"], ENT_QUOTES),
                                                   // "epf"		          =>      htmlspecialchars($_POST["editEpf"], ENT_QUOTES),
                                                   // "loan"  		       =>      htmlspecialchars($_POST["editLoan"], ENT_QUOTES),
                                                  //  "totalDeduction"  	   =>      htmlspecialchars($_POST["editTotalDeduction"], ENT_QUOTES),
                                                  //  "overtime"     		  =>      htmlspecialchars($_POST["editOvertime"], ENT_QUOTES),
                                                   // "disincentive" 		  =>      htmlspecialchars($_POST["editDisincentive"], ENT_QUOTES),
                                                    "conveyance"   		  =>      htmlspecialchars($_POST["editConveyance"], ENT_QUOTES),
                                                    "grossSalary"          =>      htmlspecialchars($_POST["editgrossSalary"], ENT_QUOTES),
                                                     "finalSalary"         =>      htmlspecialchars($_POST["editfinalSalary"], ENT_QUOTES),
