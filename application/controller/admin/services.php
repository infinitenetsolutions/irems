            ...
            case "editData":
                if($authority == 1):
                    if(!empty($_POST["editTableId"])):
                        ...
                        $databaseObj->where("`services_id` = '".$_POST["editTableId"]."'");
                        ...
                        if($getData != 0):
                            ...
                            endforeach;
                            if(!empty($_POST["editServicesName"] && $_POST["editRenewalServicesType"] && $_POST["editdaterenewalServices"] && $_POST["editpricesofService"])):
                                
                                $edit_info = array(
                                                        
                                                        "servicesName"           =>      htmlspecialchars($_POST["editServicesName"], ENT_QUOTES),
                                                        "renewalservicesType"    =>      htmlspecialchars($_POST["editRenewalServicesType"], ENT_QUOTES),
                                                        "daterenewalServices"    =>      htmlspecialchars($_POST["editdaterenewalServices"], ENT_QUOTES),
                                                        "pricesofService"        =>      htmlspecialchars($_POST["editpricesofService"], ENT_QUOTES)
                                ...
                                $tableData["services_info"] = json_encode($edit_info);
                                $tableData["services_log"] = json_encode($services_log_info);
                                $tableData["status"] = $auth->visible();
                                $check = $databaseObj->update("tbl_services", $tableData, "`services_id` = '".$_POST["editTableId"]."'");
                                if($check == 1):
                                    $data["response"] = "success";
                                    $data["responseType"] = "success";
