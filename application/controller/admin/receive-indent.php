                ...
                if($authority == 1):
                    ...
                    if(!empty($_POST["editTableId"])):
                       ...
                       if(!empty($_POST["orderNo"] && $_POST["poDate"] && $_POST["vendor_name"] && $_POST["company_name"])):
                                    ...
                                    "cgstrate" => htmlspecialchars(str_replace($slashNandR, "", $_POST["cgstrate"][$i]), ENT_QUOTES),

                                    "sgstrate" =>htmlspecialchars(str_replace($slashNandR, "", $_POST["sgstrate"][$i]), ENT_QUOTES),

                                    "igstrate" => htmlspecialchars(str_replace($slashNandR, "", $_POST["igstrate"][$i]), ENT_QUOTES),
                                    ...
                                    "total" => htmlspecialchars(str_replace($slashNandR, "", $_POST["total"][$i]), ENT_QUOTES)
                                        ...
                                        $po_info = array(
                                                       ...
                                                       "projectName" => htmlspecialchars(str_replace($slashNandR, "", $_POST["projectName"]), ENT_QUOTES),

                                                         "propertyType" => htmlspecialchars(str_replace($slashNandR, "", $_POST["propertyType"]), ENT_QUOTES),

                                                         "projectLocation" => htmlspecialchars(str_replace($slashNandR, "", $_POST["projectLocation"]), ENT_QUOTES),
