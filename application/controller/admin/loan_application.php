            ...
            case "editData":
                if($authority == 1):
                    if(!empty($_POST["editTableId"])):
                        ...
                        $databaseObj->where("`loan_id` = '".$_POST["editTableId"]."'");
                        ...
                        if($getData != 0):
                            ...
                            endforeach;
                            if(!empty($_POST["loanType"] && $_POST["loanDate"] && $_POST["loanAmount"])):
                          
                                $tableData["loan_type"] = $_POST["loanType"];
                                $tableData["loan_date"] = $_POST["loanDate"];
                                $tableData["loan_amount"] = $_POST["loanAmount"];

                               $check = $databaseObj->update("tbl_loan_application", $tableData, "`loan_id` = '".$_POST["editTableId"]."'");
