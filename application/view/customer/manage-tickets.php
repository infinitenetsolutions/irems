<?php 
    ...
    require_once("../../../application/classes-and-objects/customer-authentication.php");
    ...
    $authority = 1;
    $manageTicketStoreDir = "../../../assets/customer/manage-tickets/";
    $manageTicketDir = "../assets/customer/manage-tickets/";
    if(isset($_POST["action"])):
        ...
        switch($_POST["action"]):
            ...
            case "fetchData":
                ?>
                    <form id="selectForm" method="POST" enctype="multipart/form-data" action="../application/controller/customer/manage-tickets.php">
                                    ...
                                    <?php 
                                        ...
                                        if($getData != 0):
                                            ...
                                            foreach($getData as $rows):
                                                $manage_complain_info	= json_decode($rows["complain_info"]);
                                                $manage_complain_log = json_decode($rows["complain_log"]);
                                    ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $manage_complain_info->ticketNo ?></td>
                                                        <td><?= $manage_complain_info->clientName ?></td>
                                                        <td><?= $manage_complain_info->email ?></td>
                                                        <td><?= $manage_complain_info->priority ?></td>
                                                        <td><?= $manage_complain_info->status ?></td>
                                                        
<!--
                                                        <td><?= $manage_company_info->subject ?></td>
                                                        <td><?= $manage_company_info->content ?></td>
                                                        <td><?= $manage_company_info->scope ?></td>
                                                        <td><?= $manage_company_info->attachment ?></td>
-->
...
-->
                                                    ...
                                                    <script>
                                                        ...
                                                        $("#information-button-<?= $rows["complain_id"] ?>").click(function () {
                                                            ...
                                                            $.ajax({
                                                                url: '../application/view/customer/manage-tickets.php',
                                                                type: 'POST',
                                                                data: formData,
                                                ...
                                                <div class="col-md-12">
                                                    <div class="card">
                                                        ...
                                                        <h5><i class="icon fas fa-user-alt"></i> <?= ucfirst($complain_log_info->action) ?> By - 
                                                                    <?php
                                                                        if($complain_log_info->by == $auth->customer_id):
                                                                            echo "You";
                                                                        else:
                                                                            $databaseObj->select("tbl_customer");
                                                                            $databaseObj->where("`status` = '".$auth->visible()."' && `customer_id` = '".$complain_log_info->by."'");
                                                                            $getData = $databaseObj->get();
                                                                            //Checking If Data Is Available
                                                                            if($getData != 0):
                                                                                foreach($getData as $rows):
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="callout callout-danger">
                                                    ...
                                                    ?>
                                                            <a href="<?= $manageTicketDir.$complain_info->attachment ?>" target="_blank"><img src="<?= $manageTicketDir.$complain_info->attachment ?>" alt="" class="table-see"></a>
                                                    <?php 
                                                        endif;
                                                    ?>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="callout callout-danger">
                                                    ...
                                                    <?= $complain_info->ticketNo ?>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="callout callout-danger">
                                                    <h5 class="text-bold">Name</h5>
                                                    <?= $complain_info->clientName ?>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="callout callout-danger">
                                            ...
                                            <div class="col-md-6">
                                                <div class="callout callout-danger">
                                                    ...
                                                    <?= $complain_info->priority ?>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="callout callout-danger">
                                                    <h5 class="text-bold">Subject</h5>
                                                    <?= $complain_info->subject ?>
                                                </div>
                                            </div>
                                             ...
                                             <div class="col-md-4">
                                                <div class="callout callout-danger">
                                                    ...
                                                    <?= $complain_info->status ?>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="callout callout-danger">
                                                    <h5 class="text-bold">Content</h5>
                                                    <?= $complain_info->content ?>
                                                </div>
                                            </div>
