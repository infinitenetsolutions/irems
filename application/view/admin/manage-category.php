<?php
    ...
    if(isset($_POST["action"])):
        ...
        switch($_POST["action"]):
            ...
            case "fetchData":
                ?>
                    <form id="selectForm" method="POST" enctype="multipart/form-data" action="application/controller/admin/manage-category.php">
                        <input type="hidden" id="nameOfATable" name="nameOfATable" value="tbl_manage_category">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $databaseObj->order_by("`manage_category_id` DESC");
                                        ...
                                        if($getData != 0):
                                            ...
                                            foreach($getData as $rows):
                                                ...
                                                $manage_category_log = json_decode($rows["manage_category_log"]);
                                                // echo "<pre>";
                                                // print_r($manage_category_info->categoryName);
                                                // echo "</pre>";
                                    ?>
                                                    <tr>
                                                        <td class="text-center">
                                                            <div class="icheck-navy d-inline">
                                                                <input type="checkbox" id="checkbox-<?= $rows["manage_category_id"] ?>" name="checkbox-select[]" value="<?= $rows["manage_category_id"] ?>" class="check-table">
                                                                <label for="checkbox-<?= $rows["manage_category_id"] ?>">
                                                                </label>
                                                            </div>
                                                        </td>
                                                        <td><?= $sno ?>.</td>
                                                        <td><?= $manage_category_info->categoryName ?></td>
                                                        <td><?= $manage_category_info->categoryDescription ?></td>
                                                        <td class="text-center">
                                                            <button type="button" id="information-button-<?= $rows["manage_category_id"] ?>" class="information-button btn btn-xs btn-danger mt-1 mb-1" title="Informations">
                                                                <i class="fa fa-scroll fa-sm"></i>
                                                            </button>
                                                            <button type="button" id="see-button-<?= $rows["manage_category_id"] ?>" class="see-button btn btn-xs btn-info mt-1 mb-1" title="See">
                                                                <i class="fa fa-eye fa-sm"></i>
                                                            </button>
                                                            <button type="button" id="edit-button-<?= $rows["manage_category_id"] ?>" class="edit-button btn btn-xs btn-warning mt-1 mb-1" title="Edit/Update">
                                                                <i class="fa fa-edit fa-sm"></i>
                                                            </button>
                                                            <button type="button" id="delete-button-<?= $rows["manage_category_id"] ?>" class="delete-button btn btn-xs btn-danger mt-1 mb-1" title="Delete">
                                                    ...
                                                    <script>
                                                        ...
                                                        $("#information-button-<?= $rows["manage_category_id"] ?>").click(function () {
                                                            ...
                                                            var formData = {"action":"fetchInformation","id":"<?= $rows["manage_category_id"] ?>"};
                                                            $.ajax({
                                                                url: 'application/view/admin/manage-category.php',
                                                                type: 'POST',
                                                                data: formData,
                                                        ...
                                                        // See Section Start ---------------------------------------------------------------
                                                        $("#see-button-<?= $rows["manage_category_id"] ?>").click(function () {
                                                            ...
                                                            var formData = {"action":"fetchSee","id":"<?= $rows["manage_category_id"] ?>"};
                                                            $.ajax({
                                                                url: 'application/view/admin/manage-category.php',
                                                                type: 'POST',
                                                                data: formData,
                                                        ...
                                                        $("#delete-button-<?= $rows["manage_category_id"] ?>").click(function () {
                                                            ...
                                                            var formData = {"action":"fetchDelete","id":"<?= $rows["manage_category_id"] ?>"};
                                                            $.ajax({
                                                                url: 'application/view/admin/manage-category.php',
                                                                type: 'POST',
                                                                data: formData,
            ...
            case "fetchInformation":
                if($authority == 1):
                    if(isset($_POST["id"]) && !empty($_POST["id"])):
                        $databaseObj->select("tbl_manage_category");
                        $databaseObj->where("`status` = '".$auth->visible()."' && `manage_category_id` = '".$_POST["id"]."'");
                        $databaseObj->order_by("`manage_category_id` DESC");
                        $getData = $databaseObj->get();
                        //Checking If Data Is Available
                        if($getData != 0):
                            foreach($getData as $rows):
                                ...
                                ?>
                                    <div class="row">
                                        <?php
                                            $sno = 1;
                                            foreach($manage_category_log as $manage_category_log_info):
                                            ?>
                                                <div class="col-md-12">
                                                    <div class="card">
                                                        <div class="card-header d-flex p-0">
                                                            <ul class="nav nav-pills ml-auto p-2">
                                                                <li class="nav-item"><a class="nav-link" href="#tab_4_<?= $sno ?>" data-toggle="tab"><?= ucfirst($manage_category_log_info->action) ?> By</a></li>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="tab-content">
                                                                <div class="tab-pane" id="tab_4_<?= $sno ?>">
                                                                    <h5><i class="icon fas fa-user-alt"></i> <?= ucfirst($manage_category_log_info->action) ?> By -
                                                                    <?php
                                                                        if($manage_category_log_info->by == $auth->admin_id):
                                                                            echo "You";
                                                                        else:
                                                                            $databaseObj->select("tbl_admin");
                                                                            $databaseObj->where("`status` = '".$auth->visible()."' && `admin_id` = '".$manage_category_log_info->by."'");
                                                                            $getData = $databaseObj->get();
                                                                            //Checking If Data Is Available
                                                                            if($getData != 0):
                                                                                foreach($getData as $rows):
                                                                ...
                                                                <div class="tab-pane active" id="tab_1_<?= $sno ?>">
                                                                    ...
                                                                    <?= date("l, M d, Y", strtotime($manage_category_log_info->date)) ?> At <?= $manage_category_log_info->at ?>
                                                                </div>
                                                                <div class="tab-pane" id="tab_2_<?= $sno ?>">
                                                                    <h5><i class="icon fas fa-server"></i> IP - </h5>
                                                                    <?= $manage_category_log_info->ip ?>
                                                                </div>
                                                                <div class="tab-pane" id="tab_3_<?= $sno ?>">
                                                                    <h5><i class="icon fas fa-map-marker"></i> Location - </h5>
                                                                    <?php
                                                                        $latLangArray = explode(",", $manage_category_log_info->location);
                            ...
                            foreach($getData as $rows):
                                ...
                                ?>
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="callout callout-danger">
                                                    <h5 class="text-bold">Category Description</h5>
                                                    <?= $manage_category_info->categoryDescription ?>
                                                </div>
                                            </div>
                                        </div>
                                <?php
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="editCategoryName" name="editCategoryName" placeholder="Category Name" value="<?= $manage_category_info->categoryName ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="editCategoryAddress">Category Description</label>
                                                <textarea class="form-control" id="editCategoryDesctiption" name="editCategoryDesctiption"><?= $manage_category_info->categoryDescription ?></textarea>
                                            </div>
                                        </div>
            ...
            case "fetchDelete":
                if($authority == 1):
                    if(isset($_POST["id"]) && !empty($_POST["id"])):
                        ...
                        <input type="hidden" id="tableName" name="tableName" value="tbl_manage_category" />
                        <?php
                    else:
                        ?>
                        <div class="alert alert-danger alert-dismissible">
