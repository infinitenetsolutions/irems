<?php 
    ...
    $authority = 1;
    $manageCompanyStoreDir = "../../../assets/admin/accommodation-type/";
    $manageCompanyDir = "assets/admin/accommodation-type/";
    if(isset($_POST["action"])):
        ...
        switch($_POST["action"]):
            ...
            case "fetchData":
                ?>
                    <form id="selectForm" method="POST" enctype="multipart/form-data" action="application/controller/admin/accommodation-type.php">
                        <input type="hidden" id="nameOfATable" name="nameOfATable" value="tbl_accommodation_type">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        $databaseObj->order_by("`accommodation_type_id` DESC");
                                        ...
                                        if($getData != 0):
                                            ...
                                            foreach($getData as $rows):
                                                ...
                                                $accommodation_type_log = json_decode($rows["accommodation_type_log"]);
                                    ?>
                                                    <tr>
                                                        <td class="text-center">
                                                            <div class="icheck-navy d-inline">
                                                                <input type="checkbox" id="checkbox-<?= $rows["accommodation_type_id"] ?>" name="checkbox-select[]" value="<?= $rows["accommodation_type_id"] ?>" class="check-table">
                                                                <label for="checkbox-<?= $rows["accommodation_type_id"] ?>">
                                                                </label>
                                                            </div>
                                                        </td>
                                                        <td><?= $sno ?>.</td>
                                                        <td><?= $accommodation_type_info->accommodationType ?></td>
                                                        <td class="text-center">
                                                            <button type="button" id="information-button-<?= $rows["accommodation_type_id"] ?>" class="information-button btn btn-xs btn-danger mt-1 mb-1" title="Informations">
                                                                <i class="fa fa-scroll fa-sm"></i>
                                                            </button>
                                                            <button type="button" id="see-button-<?= $rows["accommodation_type_id"] ?>" class="see-button btn btn-xs btn-info mt-1 mb-1" title="See">
                                                                <i class="fa fa-eye fa-sm"></i>
                                                            </button>
                                                            <button type="button" id="edit-button-<?= $rows["accommodation_type_id"] ?>" class="edit-button btn btn-xs btn-warning mt-1 mb-1" title="Edit/Update">
                                                                <i class="fa fa-edit fa-sm"></i>
                                                            </button>
                                                            <button type="button" id="delete-button-<?= $rows["accommodation_type_id"] ?>" class="delete-button btn btn-xs btn-danger mt-1 mb-1" title="Delete">
                                                    ...
                                                    <script>
                                                        ...
                                                        $("#information-button-<?= $rows["accommodation_type_id"] ?>").click(function () {
                                                            ...
                                                            var formData = {"action":"fetchInformation","id":"<?= $rows["accommodation_type_id"] ?>"};
                                                            $.ajax({
                                                                url: 'application/view/admin/accommodation-type.php',
                                                                type: 'POST',
                                                                data: formData,
                                                        ...
                                                        // See Section Start ---------------------------------------------------------------
                                                        $("#see-button-<?= $rows["accommodation_type_id"] ?>").click(function () {
                                                            ...
                                                            var formData = {"action":"fetchSee","id":"<?= $rows["accommodation_type_id"] ?>"};
                                                            $.ajax({
                                                                url: 'application/view/admin/accommodation-type.php',
                                                                type: 'POST',
                                                                data: formData,
                                                        ...
                                                        // See Section End -----------------------------------------------------------------
                                                        // Edit Section Start ---------------------------------------------------------------
                                                        $("#edit-button-<?= $rows["accommodation_type_id"] ?>").click(function () {
                                                            $("#edit-modal").modal('show');
                                                            $('#edit-section').html('<center id = "edit-loading"><img width="80px" src = "assets/loader/pre-loader.gif" alt="Loading..." /></center>');
                                                            var formData = {"action":"fetchEdit","id":"<?= $rows["accommodation_type_id"] ?>"};
                                                            $.ajax({
                                                                url: 'application/view/admin/accommodation-type.php',
                                                                type: 'POST',
                                                                data: formData,
                                                        ...
                                                        $("#delete-button-<?= $rows["accommodation_type_id"] ?>").click(function () {
                                                            ...
                                                            var formData = {"action":"fetchDelete","id":"<?= $rows["accommodation_type_id"] ?>"};
                                                            $.ajax({
                                                                url: 'application/view/admin/accommodation-type.php',
                                                                type: 'POST',
                                                                data: formData,
            ...
            case "fetchInformation":
                if($authority == 1):
                    if(isset($_POST["id"]) && !empty($_POST["id"])):
                        $databaseObj->select("tbl_accommodation_type");
                        $databaseObj->where("`status` = '".$auth->visible()."' && `accommodation_type_id` = '".$_POST["id"]."'");
                        $databaseObj->order_by("`accommodation_type_id` DESC");
                        $getData = $databaseObj->get();
                        //Checking If Data Is Available
                        if($getData != 0):
                            foreach($getData as $rows):
                                ...
                                ?>
                                    <div class="row">
                                        <?php
                                            $sno = 1;
                                            foreach($accommodation_type_log as $accommodation_type_log_info):
                                            ?>
                                                <div class="col-md-12">
                                                    <div class="card">
                                                        <div class="card-header d-flex p-0">
                                                            <ul class="nav nav-pills ml-auto p-2">
                                                                <li class="nav-item"><a class="nav-link" href="#tab_4_<?= $sno ?>" data-toggle="tab"><?= ucfirst($accommodation_type_log_info->action) ?> By</a></li>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="tab-content">
                                                                <div class="tab-pane" id="tab_4_<?= $sno ?>">
                                                                    <h5><i class="icon fas fa-user-alt"></i> <?= ucfirst($accommodation_type_log_info->action) ?> By - 
                                                                    <?php
                                                                        if($accommodation_type_log_info->by == $auth->admin_id):
                                                                            echo "You";
                                                                        else:
                                                                            $databaseObj->select("tbl_admin");
                                                                            $databaseObj->where("`status` = '".$auth->visible()."' && `admin_id` = '".$accommodation_type_log_info->by."'");
                                                                            $getData = $databaseObj->get();
                                                                            //Checking If Data Is Available
                                                                            if($getData != 0):
                                                                                foreach($getData as $rows):
                                                                ...
                                                                <div class="tab-pane active" id="tab_1_<?= $sno ?>">
                                                                    ...
                                                                    <?= date("l, M d, Y", strtotime($accommodation_type_log_info->date)) ?> At <?= $accommodation_type_log_info->at ?>
                                                                </div>
                                                                <div class="tab-pane" id="tab_2_<?= $sno ?>">
                                                                    <h5><i class="icon fas fa-server"></i> IP - </h5>
                                                                    <?= $accommodation_type_log_info->ip ?>
                                                                </div>
                                                                <div class="tab-pane" id="tab_3_<?= $sno ?>">
                                                                    <h5><i class="icon fas fa-map-marker"></i> Location - </h5>
                                                                    <?php
                                                                        $latLangArray = explode(",", $accommodation_type_log_info->location);
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="editAccommodationType">Accommodation Type</label>
                                                <input type="text" class="form-control" id="editAccommodationType" name="editAccommodationType" placeholder="Accommodation Type" value="<?= $accommodation_type_info->accommodationType ?>">
                                            </div>
                                        </div>
            ...
            case "fetchDelete":
                if($authority == 1):
                    if(isset($_POST["id"]) && !empty($_POST["id"])):
                        ...
                        <input type="hidden" id="tableName" name="tableName" value="tbl_accommodation_type" />
                        <?php
                    else:
                        ?>
                        <div class="alert alert-danger alert-dismissible">
