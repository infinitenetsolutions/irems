            ...
            case "fetchData":
                ...
                ?>
                    ...
                    <form id="selectForm" method="POST" enctype="multipart/form-data" action="application/controller/admin/manage-department.php">
                        ...
                        <input type="hidden" id="nameOfATable" name="nameOfATable" value="tbl_manage_department">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        $databaseObj->order_by("`manage_department_id` DESC");
                                        ...
                                        if($getData != 0):
                                            ...
                                            foreach($getData as $rows):
                                                ...
                                                $manage_department_log = json_decode($rows["manage_department_log"]);
                                    ...
                                    ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <div class="icheck-navy d-inline">
                                                                ...
                                                                <input type="checkbox" id="checkbox-<?= $rows["manage_department_id"] ?>" name="checkbox-select[]" value="<?= $rows["manage_department_id"] ?>" class="check-table">

                                                                <label for="checkbox-<?= $rows["manage_department_id"] ?>">
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <button type="button" id="information-button-<?= $rows["manage_department_id"] ?>" class="information-button btn btn-xs btn-danger mt-1 mb-1" title="Informations">

                                                                <i class="fa fa-scroll fa-sm"></i>

                                                            </button>

                                                            <button type="button" id="see-button-<?= $rows["manage_department_id"] ?>" class="see-button btn btn-xs btn-info mt-1 mb-1" title="See">

                                                                <i class="fa fa-eye fa-sm"></i>

                                                            </button>

                                                            <button type="button" id="edit-button-<?= $rows["manage_department_id"] ?>" class="edit-button btn btn-xs btn-warning mt-1 mb-1" title="Edit/Update">

                                                                <i class="fa fa-edit fa-sm"></i>

                                                            </button>

                                                            <button type="button" id="delete-button-<?= $rows["manage_department_id"] ?>" class="delete-button btn btn-xs btn-danger mt-1 mb-1" title="Delete">
                                                    ...
                                                    <script>
                                                        ...
                                                        $("#information-button-<?= $rows["manage_department_id"] ?>").click(function () {
                                                            ...
                                                            var formData = {"action":"fetchInformation","id":"<?= $rows["manage_department_id"] ?>"};

                                                            $.ajax({

                                                                url: 'application/view/admin/manage-department.php',
                                                        ...
                                                        $("#see-button-<?= $rows["manage_department_id"] ?>").click(function () {
                                                            ...
                                                            var formData = {"action":"fetchSee","id":"<?= $rows["manage_department_id"] ?>"};
                                                        ...
                                                        $("#delete-button-<?= $rows["manage_department_id"] ?>").click(function () {
                                                            ...
                                                            var formData = {"action":"fetchDelete","id":"<?= $rows["manage_department_id"] ?>"};
            ...
            case "fetchInformation":
                ...
                if($authority == 1):
                    ...
                    if(isset($_POST["id"]) && !empty($_POST["id"])):
                        ...
                        $databaseObj->where("`status` = '".$auth->visible()."' && `manage_department_id` = '".$_POST["id"]."'");
                                ...
                                ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <?php
                                            ...
                                            foreach($manage_department_log as $manage_department_log_info):
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-header d-flex p-0">
                                                            ...
                                                            <ul class="nav nav-pills ml-auto p-2">
                                                                ...
                                                                <li class="nav-item"><a class="nav-link" href="#tab_4_<?= $sno ?>" data-toggle="tab"><?= ucfirst($manage_department_log_info->action) ?> By</a></li>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="tab-content">
                                                                ...
                                                                <div class="tab-pane" id="tab_4_<?= $sno ?>">
                                                                    ...
                                                                    <h5><i class="icon fas fa-user-alt"></i> <?= ucfirst($manage_department_log_info->action) ?> By -

                                                                    <?php

                                                                        if($manage_department_log_info->by == $auth->admin_id):
                                                                            ...
                                                                            $databaseObj->where("`status` = '".$auth->visible()."' && `admin_id` = '".$manage_department_log_info->by."'");
                                                                ...
                                                                <div class="tab-pane active" id="tab_1_<?= $sno ?>">
                                                                    ...
                                                                    <?= date("l, M d, Y", strtotime($manage_department_log_info->date)) ?> At <?= $manage_department_log_info->at ?>
                                                                ...
                                                                <div class="tab-pane" id="tab_3_<?= $sno ?>">
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        $latLangArray = explode(",", $manage_department_log_info->location);
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="callout callout-danger">
                                                    ...
                                                    <?= $manage_department_info->designationName ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="editdepartmentName" name="editdepartmentName" placeholder="Department" value="<?= $manage_department_info->departmentName ?>">
            ...
            case "fetchDelete":
                ...
                if($authority == 1):
                    ...
                    if(isset($_POST["id"]) && !empty($_POST["id"])):
                        ...
                        <input type="hidden" id="tableName" name="tableName" value="tbl_manage_department" />
