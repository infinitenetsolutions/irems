                                    ...
                                    ?>
                                                    <tr>
                                                        <td class="text-center">
                                                            <div class="icheck-navy d-inline">
                                                                <input type="checkbox" id="checkbox-<?= $rows["manage_item_id"] ?>" name="checkbox-select[]" value="<?= $rows["manage_item_id"] ?>" class="check-table">
                                                       ...
                                                       <!--  <td><?= $projects_info->projectName ?></td> -->
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <button type="button" id="edit-button-<?= $rows["manage_item_id"] ?>" class="edit-button btn btn-xs btn-warning mt-1 mb-1" title="Edit/Update">
                                                                <i class="fa fa-edit fa-sm"></i>
                                                            </button>
                                                            <button type="button" id="delete-button-<?= $rows["manage_item_id"] ?>" class="delete-button btn btn-xs btn-danger mt-1 mb-1" title="Delete">
                                                                <i class="fa fa-trash fa-sm"></i>
                                                            </button>
                                                           <!--  <button type="button" id="switch-button-<?= $rows["manage_item_id"] ?>" class="switch-button btn btn-xs btn-danger mt-1 mb-1" title="Switch">
                                                    ...
                                                    <script>
                                                        ...
                                                        $("#information-button-<?= $rows["manage_item_id"] ?>").click(function () {
                                                            ...
                                                            var formData = {"action":"fetchInformation","id":"<?= $rows["manage_item_id"] ?>"};
                                                            $.ajax({
                                                                url: 'application/view/admin/manage-item.php',
                                                                type: 'POST',
                                                                data: formData,
                                                        ...
                                                        // See Section Start ---------------------------------------------------------------
                                                        $("#see-button-<?= $rows["manage_item_id"] ?>").click(function () {
                                                            ...
                                                            var formData = {"action":"fetchSee","id":"<?= $rows["manage_item_id"] ?>"};
                                                            $.ajax({
                                                                url: 'application/view/admin/manage-item.php',
                                                                type: 'POST',
                                                                data: formData,
                                                        ...
                                                        $("#switch-button-<?= $rows["manage_item_id"] ?>").click(function () {
                                                            ...
                                                            var formData = {"action":"fetchSwitch","id":"<?= $rows["manage_item_id"] ?>"};
                                                            $.ajax({
