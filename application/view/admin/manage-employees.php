    ...
    if(isset($_POST["action"])):
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $manage_employee_info->empType ?></td>
                <td>
                    <?php
...
<?php
                        ...
                        if($getData != 0):
                            ...
                            <div class="row">
                              ...
                              <!--  <div class="col-md-3">     
                                    <div class="form-group">
                                        <label>ESI</label>
                                        <input type="number" class="form-control form-control-sm editDeduction" id="editEsi" name="editEsi" value="<?//= intval($manage_employee_info->esi) ?>" onkeyup="editgetDeduction()"/>
                                    </div>
                                </div> -->
  ...
  function income()
    ...
    if(netsal > 0 || netsal <= 20000){
        ...
        $("#finalSalary").val(Number($("#totalSalary").val()) - Number($("#totalDeduction").val()));
...
<script>
    function editgetDeduction()
    {
        $("#editTotalDeduction").val(Number($('#editEpf').val())+Number($('#editEsi').val())+Number($('#editLoan').val()));
        $("#editgrossSalary").val(Number($("#edittotalSalary").val()) - Number($('#editEpf').val())-Number($('#editEsi').val())-Number($('#editLoan').val()));
        $("#editfinalSalary").val(Number($("#edittotalSalary").val()) - Number($('#editEpf').val())-Number($('#editEsi').val())-  Number($('#editLoan').val()));
    }
  
  function editgetAmount(){
    var netsal = $('#editnetSalary').val();
   
    if(netsal > 0 || netsal <= 20000){
        $('#editbasicSalary').val(netsal*40/100);
        $('#editHra').val(netsal*20/100);

        $('#editTa').val(netsal*15/100);
        $('#editCea').val(netsal*15/100);
        $('#editSa').val(netsal*10/100);
        // var x =  Number('#amount') + Number('value2');
        $("#edittotalSalary").val(netsal);
      	$("#editgrossSalary").val(netsal-Number($("#editTotalDeduction").val()));
      	$("#editfinalSalary").val(netsal-Number($("#editTotalDeduction").val()));
       // $("#editgrossSalary").val(Number($("#edittotalSalary").val()) - Number($("#editTotalDeduction").val()));
       // $("#editfinalSalary").val(Number($("#edittotalSalary").val()) - Number($("#editTotalDeduction").val()));
        // $("#totalSalary").val(Number($("#basicSalary").val()) + Number($("#hra").val()) + Number($("#ta").val()) + Number($("#cea").val()) + Number($("#sa").val())  + Number($("#netSalary").val()));

    }else  if(netsal > 20000 || netsal <= 30000){
        $('#editbasicSalary').val(netsal*35/100);
        $('#editHra').val(netsal*18/100);

        $('#editTa').val(netsal*18/100);
        $('#editCea').val(netsal*18/100);
        $('#editSa').val(netsal*11/100);
        // $("#totalSalary").val(Number($("#basicSalary").val()) + Number($("#hra").val()) + Number($("#ta").val()) + Number($("#cea").val()) + Number($("#sa").val())  + Number($("#netSalary").val()));
        $("#edittotalSalary").val(netsal);
      	$("#editgrossSalary").val(netsal-Number($("#editTotalDeduction").val()));
      	$("#editfinalSalary").val(netsal-Number($("#editTotalDeduction").val()));
        ...
        $('#editbasicSalary').val(netsal*30/100);
        $('#editHra').val(netsal*15/100);

        $('#editTa').val(netsal*22/100);
        $('#editCea').val(netsal*22/100);
        $('#editSa').val(netsal*11/100);
        // $("#totalSalary").val(Number($("#basicSalary").val()) + Number($("#hra").val()) + Number($("#ta").val()) + Number($("#cea").val()) + Number($("#sa").val())  + Number($("#netSalary").val()));
        $("#edittotalSalary").val(netsal);
  		$("#editgrossSalary").val(netsal-Number($("#editTotalDeduction").val()));
        ...
        $('#editbasicSalary').val(netsal*25/100);
        $('#editHra').val(netsal*13/100);

        $('#editTa').val(netsal*25/100);
        $('#editCea').val(netsal*25/100);
        $('#editSa').val(netsal*12/100);
        // $("#totalSalary").val(Number($("#basicSalary").val()) + Number($("#hra").val()) + Number($("#ta").val()) + Number($("#cea").val()) + Number($("#sa").val())  + Number($("#netSalary").val()));
        $("#edittotalSalary").val(netsal);
      	$("#editgrossSalary").val(netsal-Number($("#editTotalDeduction").val()));
      	$("#editfinalSalary").val(netsal-Number($("#editTotalDeduction").val()));
