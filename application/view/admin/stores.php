        ...
        switch($_POST["action"]):
            ...
            case "fetchData":
                ...
                ?>
                    ...
                    <form id="selectForm" method="POST" enctype="multipart/form-data" action="application/controller/admin/stores.php">
                                                ...
                                                foreach($getData as $rowsmanage):
                                                   $manage_stock_log = json_decode($rowsmanage["manage_stock_log"]);?>
                                                    <tr>
                                                        ...
                                                        $databaseObj->where("`status` = '".$auth->visible()."' && `manage_category_id` = '".$rowsmanage["itemCategory"]."'");
                                                        $getData = $databaseObj->get();
                                                        if($getData != 0):
                                                        ...
                                                        <td class="text-center">
                                                             ...
                                                             <button type="button" id="edit-button-<?= $rowsmanage["manage_stock_id"] ?>" class="edit-button btn btn-xs btn-warning mt-1 mb-1" title="Edit/Update">
                                                    ...
                                                    <script>
                                                        ...
                                                        $("#delete-button-<?= $rowsmanage["manage_stock_id"] ?>").click(function () {
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                url: 'application/view/admin/stores.php',
