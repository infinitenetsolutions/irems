$(function(){
    ...
    $('form#addForm').submit(function (event) {
        ...
        if($("#supplierState").val() == ""){
            $("#supplierState").addClass("is-invalid");
            flag = 0;
        }else
            $("#supplierState").removeClass("is-invalid");
        if($("#supplierCountry").val() == ""){
            $("#supplierCountry").addClass("is-invalid");
            flag = 0;
        }else
            $("#supplierCountry").removeClass("is-invalid");
        ...
        if($("#supplierGstin").val() == ""){
            $("#supplierGstin").addClass("is-invalid");
            flag = 0;
        }else
            $("#supplierGstin").removeClass("is-invalid");
        if(flag == 1){
            ...
            $.ajax({
                url: 'application/controller/admin/manage-supplier.php',
                type: 'POST',
                data: formData,
                dataType: "json",
                success: function (data) {
    ...
    $('form#editForm').submit(function (event) {
        ...
        var flag = 1;
        if($("#editSupplierName").val() == ""){
            $("#editSupplierName").addClass("is-invalid");
            flag = 0;
        }else
            $("#editSupplierName").removeClass("is-invalid");
        if($("#editSupplierCity").val() == ""){
            $("#editSupplierCity").addClass("is-invalid");
            flag = 0;
        }else
            $("#editSupplierCity").removeClass("is-invalid");
        if($("#editSupplierState").val() == ""){
            $("#editSupplierState").addClass("is-invalid");
            flag = 0;
        }else
            $("#editSupplierState").removeClass("is-invalid");
        if($("#editSupplierCountry").val() == ""){
            $("#editSupplierCountry").addClass("is-invalid");
            flag = 0;
        }else
            $("#editSupplierCountry").removeClass("is-invalid");
        if($("#editSupplierAddress").val() == ""){
            $("#editSupplierAddress").addClass("is-invalid");
            flag = 0;
        }else
            $("#editSupplierAddress").removeClass("is-invalid");
        if($("#editSupplierPhone").val() == ""){
            $("#editSupplierPhone").addClass("is-invalid");
            flag = 0;
        }else
            $("#editSupplierPhone").removeClass("is-invalid");
        if($("#editSupplierEmail").val() == ""){
            $("#editSupplierEmail").addClass("is-invalid");
            flag = 0;
        }else
            $("#editSupplierEmail").removeClass("is-invalid");
        if($("#editSupplierGstin").val() == ""){
            $("#editSupplierGstin").addClass("is-invalid");
            flag = 0;
        }else
            $("#editSupplierGstin").removeClass("is-invalid");
        if(flag == 1){
