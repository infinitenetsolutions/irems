...
//CKEDITOR.instances.nameOfTextarea.getData(); For Fetching Ck Editor Data
$(function () {
    
  
    $('#example1').dataTable({
        "lengthMenu": [[10, 25, 50, 75, 100, 250, 500, 750, 1000, 2500, 5000, 7500, 10000, -1], [5, 10, 25, 50, 75, 100, 250, 500, 750, 1000, 2500, 5000, 7500, 10000, "All"]],
        "language": {
            "paginate": {
