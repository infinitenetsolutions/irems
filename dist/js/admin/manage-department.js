$(function(){
    ...
    $('form#addForm').submit(function (event) {
        ...
        if(flag == 1){
            ...
            $.ajax({
                ...
                url: 'application/controller/admin/manage-department.php',
    ...
    $('form#editForm').submit(function (event) {
        ...
        if($("#editdesignationName").val() == ""){

            $("#editdesignationName").addClass("is-invalid");

            flag = 0;

        }else

            $("#editdesignationName").removeClass("is-invalid");
