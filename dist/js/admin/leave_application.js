$(function () {
    ...
    $('form#addForm').submit(function (event) {
        ...
        var flag = 1;
        if ($("#servicesName").val() == "") {
            $("#servicesName").addClass("is-invalid");
            flag = 0;
        } else
            $("#servicesName").removeClass("is-invalid");
        if ($("#renewalservicesType").val() == "") {
            $("#renewalservicesType").addClass("is-invalid");
            flag = 0;
        } else
            $("#renewalservicesType").removeClass("is-invalid");
        if ($("#daterenewalServices").val() == "") {
            $("#daterenewalServices").addClass("is-invalid");
            flag = 0;
        } else
            $("#daterenewalServices").removeClass("is-invalid");
        if ($("#pricesofService").val() == "") {
            $("#pricesofService").addClass("is-invalid");
            flag = 0;
        } else
            $("#pricesofService").removeClass("is-invalid");
        if (flag == 1) {
            ...
            $.ajax({
                url: 'application/controller/admin/leave_application.php',
                type: 'POST',
                data: formData,
                dataType: "json",
                success: function (data) {
    ...
    $('form#editForm').submit(function (event) {
        ...
        var flag = 1;
        if ($("#editServicesName").val() == "") {
            $("#editServicesName").addClass("is-invalid");
            flag = 0;
        } else
            $("#editServicesName").removeClass("is-invalid");
        if ($("#editRenewalServicesType").val() == "") {
            $("#editRenewalServicesType").addClass("is-invalid");
            flag = 0;
        } else
            $("#editRenewalServicesType").removeClass("is-invalid");
        if ($("#editdaterenewalServices").val() == "") {
            $("#editdaterenewalServices").addClass("is-invalid");
            flag = 0;
        } else
            $("#editdaterenewalServices").removeClass("is-invalid");
        if ($("#editpricesofService").val() == "") {
            $("#editpricesofService").addClass("is-invalid");
            flag = 0;
        } else
            $("#editpricesofService").removeClass("is-invalid");
        if (flag == 1) {
