$(function(){
    ...
    $('form#addForm').submit(function (event) {
        ...
        var flag = 1;
        if($("#work-type").val() == ""){
            $("#work-type").addClass("is-invalid");
            flag = 0;
        }else
            $("#work-type").removeClass("is-invalid");
        if(flag == 1){
            ...
            $.ajax({
                url: 'application/controller/admin/work-type.php',
                type: 'POST',
                data: formData,
                dataType: "json",
                success: function (data) {
    ...
    $('form#editForm').submit(function (event) {
        ...
        var flag = 1;
        if($("#editWorkType").val() == ""){
            $("#editWorkType").addClass("is-invalid");
            flag = 0;
        }else
            $("#editWorkType").removeClass("is-invalid");
        if(flag == 1){
