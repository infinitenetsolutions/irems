$(function(){
  ...
  // Fetch Data Section Start --------------------------------------------------------------------------------------------------------------------
    function fetchFn() {
        ...
        $.ajax({
            url: 'application/view/admin/settings.php',
            type: 'POST',
            data: formData,
    ...
    $('form#addForm').submit(function (event) {
        ...
        if($("#companyCity").val() == ""){
            $("#companyCity").addClass("is-invalid");
            flag = 0;
        }else
            $("#companyCity").removeClass("is-invalid");
        if($("#companyState").val() == ""){
            $("#companyState").addClass("is-invalid");
            flag = 0;
        }else
            $("#companyState").removeClass("is-invalid");
        if($("#companyPincode").val() == ""){
            $("#companyPincode").addClass("is-invalid");
            flag = 0;
        }else
            $("#companyPincode").removeClass("is-invalid");
        if(flag == 1){
    ...
    $('form#editForm').submit(function (event) {
        ...
        var flag = 1;
        if($("#editPurchaser").val() == ""){
            $("#editPurchaser").addClass("is-invalid");
            flag = 0;
        }else
            $("#editPurchaser").removeClass("is-invalid");
        if($("#editPurchasedDate").val() == ""){
            $("#editPurchasedDate").addClass("is-invalid");
            flag = 0;
        }else
            $("#editPurchasedDate").removeClass("is-invalid");
        if($("#editPurchasedPrice").val() == ""){
            $("#editPurchasedPrice").addClass("is-invalid");
            flag = 0;
        }else
            $("#editPurchasedPrice").removeClass("is-invalid");
        if($("#editDomain").val() == ""){
            $("#editDomain").addClass("is-invalid");
            flag = 0;
        }else
            $("#editDomain").removeClass("is-invalid");
         if($("#editMailService").val() == ""){
            $("#editMailService").addClass("is-invalid");
            flag = 0;
        }else
            $("#editMailService").removeClass("is-invalid");
         if($("#editMailService").val() == ""){
            $("#editMailService").addClass("is-invalid");
            flag = 0;
        }else
