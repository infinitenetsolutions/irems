$(function(){
    ...
    $('form#addForm').submit(function (event) {
        ...
        var flag = 1;
        if($("#phase").val() == ""){
            $("#phase").addClass("is-invalid");
            flag = 0;
        }else
            $("#phase").removeClass("is-invalid");
        if(flag == 1){
            ...
            $.ajax({
                url: 'application/controller/admin/phase.php',
                type: 'POST',
                data: formData,
                dataType: "json",
                success: function (data) {
    ...
    $('form#editForm').submit(function (event) {
        ...
        var flag = 1;
        if($("#editPhase").val() == ""){
            $("#editPhase").addClass("is-invalid");
            flag = 0;
        }else
            $("#editPhase").removeClass("is-invalid");
        if(flag == 1){
