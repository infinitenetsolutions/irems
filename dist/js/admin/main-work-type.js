$(function(){
    ...
    $('form#addForm').submit(function (event) {
        ...
        var flag = 1;
        if($("#main-work-type").val() == ""){
            $("#main-work-type").addClass("is-invalid");
            flag = 0;
        }else
            $("#main-work-type").removeClass("is-invalid");
        if(flag == 1){
            ...
            $.ajax({
                url: 'application/controller/admin/main-work-type.php',
                type: 'POST',
                data: formData,
                dataType: "json",
                success: function (data) {
    ...
    $('form#editForm').submit(function (event) {
        ...
        var flag = 1;
        if($("#editMainWorkType").val() == ""){
            $("#editMainWorkType").addClass("is-invalid");
            flag = 0;
        }else
            $("#editMainWorkType").removeClass("is-invalid");
        if(flag == 1){
