$(function(){
    ...
    $('form#addForm').submit(function (event) {
        ...
        if(flag == 1){
            ...
            $.ajax({
                url: 'application/controller/admin/manage-item.php',
                type: 'POST',
                data: formData,
                dataType: "json",
                success: function (data) {
    ...
    $('form#editForm').submit(function (event) {
        ...
        if($("#editItemUom").val() == ""){
            $("#editItemUom").addClass("is-invalid");
            flag = 0;
        }else
            $("#editItemUom").removeClass("is-invalid");
        ...
        if($("#editItemQty").val() == ""){
            $("#editItemQty").addClass("is-invalid");
            flag = 0;
        }else
            $("#editItemQty").removeClass("is-invalid");
        if($("#editItemReOrder").val() == ""){
            $("#editItemReOrder").addClass("is-invalid");
            flag = 0;
        }else
            $("#editItemReOrder").removeClass("is-invalid");
        if(flag == 1){
