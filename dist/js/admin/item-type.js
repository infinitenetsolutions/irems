$(function(){
    ...
    $('form#addForm').submit(function (event) {
        ...
        var flag = 1;
        if($("#item-type").val() == ""){
            $("#item-type").addClass("is-invalid");
            flag = 0;
        }else
            $("#item-type").removeClass("is-invalid");
        if(flag == 1){
            ...
            $.ajax({
                url: 'application/controller/admin/item-type.php',
                type: 'POST',
                data: formData,
                dataType: "json",
                success: function (data) {
    ...
    $('form#editForm').submit(function (event) {
        ...
        var flag = 1;
        if($("#editItemType").val() == ""){
            $("#editItemType").addClass("is-invalid");
            flag = 0;
        }else
            $("#editItemType").removeClass("is-invalid");
        if(flag == 1){
