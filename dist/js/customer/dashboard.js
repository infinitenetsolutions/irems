...
//         alert('hello');    
        ...
        $.ajax({
            url: '../application/view/customer/dashboard.php',
            type: 'POST',
            data: formData,
    ...
    $('form#addForm').submit(function (event) {
        ...
        if($("#secondApplicantName").val() == ""){
            ...
            flag = 0;
            errorMessage = "Please fill out Second Applicant Informations!!!";
        ...
        if($("#firstApplicantName").val() == ""){
            ...
            flag = 0;
            errorMessage = "Please fill out First Applicant Informations!!!";
        ...
        if($("#firstApplicanPermanentAddress").val() == ""){
        ...
        if($("#firstApplicanCorrespondenceAddress").val() == ""){
        ...
        for(j = 1; j <= Number($("#totalNumberOfDivision").val()); j++){
            if($("#paymentStuctureCompletion"+j).val() == ""){
                ...
                flag = 0;
                errorMessage = "Please fill out Payment Structure Informations";
        ...
        if($("#paymentAmount").val() != "" && Number($("#paymentAmount").val()) > 0){
            if($("#paymentAmountNumber").val() == ""){
                ...
                flag = 0;
                errorMessage = "Please fill out Payment Informations";
        ...
        if($("#projectName").val() == ""){
            ...
            flag = 0;
            errorMessage = "Please fill out Property Informations";
...
//            $("#propertyLocation").removeClass("is-invalid");
        if(flag == 1){
            ...
            $.ajax({
                url: '../application/controller/customer/dashboard.php',
                type: 'POST',
                data: formData,
                dataType: "json",
                success: function (data) {
...
//        $('#accommodationType').prop("disabled", true);
//        $('#squareFeet').prop("disabled", true);
//        $('#pricePerSquare').prop("disabled", true);
//        $('#projectName').prop("disabled", true);
//        $('#propertyLocation').prop("disabled", true);
//        $('#propertyPrice').prop("disabled", true);
//        $('#propertyPriceDeal').prop("disabled", true);
//        $('#propertyNumber').prop("disabled", true);
//        $('#propertyLocation').val("");
//        $('#propertyPrice').val("");
//        $('#propertyPriceDeal').val("");
//        $('#propertyNumber').val("");
//        var formData = {"action":"fetchPhaseWithProjectId","id":$("#projectName").val()};
//        $.ajax({
//            url: 'application/view/admin/customer.php',
//            type: 'POST',
//            data: formData,
//            success: function (data) {
//                setTimeout( function() {
//                    if(data == "no"){
//                        topEndNotification("info", "No Phase Available...");
//                        $('#phase').html('<option value="" selected>No Phase added on this Project...</option>');
//                        setTimeout( function() {
//                            topEndNotification("info", "Searching for Blocks...");
//                            var formData = {"action":"fetchBlockWithProjectId","id":$("#projectName").val()};
//                            $.ajax({
//                                url: 'application/view/admin/customer.php',
//                                type: 'POST',
//                                data: formData,
...
//                                    setTimeout( function() {
//                                        if(data == "no"){
//                                            topEndNotification("info", "No Block Available...");
//                                            $('#block').html('<option value="" selected>No Block added on this Project...</option>');
//                                            setTimeout( function() {
//                                                topEndNotification("info", "Searching for Buildings...");
//                                                var formData = {"action":"fetchBuildingWithProjectId","id":$("#projectName").val()};
//                                                $.ajax({
//                                                    url: 'application/view/admin/customer.php',
//                                                    type: 'POST',
//                                                    data: formData,
...
//                                                        setTimeout( function() {
//                                                            if(data == "no"){
//                                                                topEndNotification("info", "No Building Available...");
//                                                                $('#building').html('<option value="" selected>No Building added on this Project...</option>');
//                                                                setTimeout( function() {
//                                                                    topEndNotification("info", "Searching for Properties...");
//                                                                    var formData = {"action":"fetchPropertyTypeWithProjectId","id":$("#projectName").val()};
//                                                                    $.ajax({
//                                                                        url: 'application/view/admin/customer.php',
//                                                                        type: 'POST',
//                                                                        data: formData,
//                                                                        success: function (data) {
//                                                                            setTimeout( function() {
//                                                                                topEndNotification("info", "Please select Property Type...");
...
//                                                                }, 1000);
//                                                            } else{
//                                                                topEndNotification("info", "Please select Building...");
//                                                                $('#building').html(data);
//                                                                $('#projectName').prop("disabled", false);
...
//    });
    $("#projectName").change(function () {
        topEndNotification("info", "Please Wait...");
        $('#inner-property').html('<center id = "loading"><img width="80px" src = "../assets/loader/pre-loader.gif" alt="Loading..." /></center>');
        $('#projectName').prop("disabled", true);
        $('#block').val("");
        $('#building').val("");
        $('#phase').val("");
        ...
        $('#propertyPriceDeal').val("");
        $('#propertyNumber').val("");
        $('#propertyPriceDeal').attr("readonly", "readonly");
        $('#propertyNumber').attr("readonly", "readonly");
        var formData = {"action":"fetchInnerPropertyWithProjectId","id":$("#projectName").val()};
        $.ajax({
            url: '../application/view/customer/dashboard.php',
            type: 'POST',
            data: formData,
            success: function (data) {
                setTimeout( function() {
                    topEndNotification("info", "Properties loaded successfully!!!");
                    $('#inner-property').html(data);
                    $('#projectName').prop("disabled", false);
                    $('#propertyPriceDeal').removeAttr("readonly");
                    $('#propertyNumber').removeAttr("readonly");
                }, 500);
            }
        });
    });
        ...
        if($('#propertyPriceDeal').val() == ""){
            ...
            if($("#paymentAmount").val() > 0 && $("#propertyPriceDeal").val() > 0){
                if(Number($("#paymentAmount").val()) > Number(totalPriceOfProperty)){
                    ...
                    $("#paymentStuctureRemark1").val("Down Payment");
    ...
    $('#firstApplicantCalculateAge').click( function () {
        ...
        $.ajax({
            url: '../application/view/customer/dashbaord.php',
            type: 'POST',
            data: formData,
            success: function (data) {
                setTimeout( function() {
...
function calculateAmount() {
    ...
    if($('#propertyPriceDeal').val() == ""){
        ...
        for(i = 1; i <= totalRows; i++){
            ...
            if($("#paymentStuctureCompletion"+i).val() == ""){
