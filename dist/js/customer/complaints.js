$(function(){
    ...
    $('form#editForm').submit(function (event) {
        ...
        var flag = 1;
        if($("#editTicketNo").val() == ""){
            $("#editTicketNo").addClass("is-invalid");
            flag = 0;
        }else
            $("#editTicketNo").removeClass("is-invalid");
        ...
        if($("#editSubject").val() == ""){
            $("#editSubject").addClass("is-invalid");
            flag = 0;
        }else
            $("#editSubject").removeClass("is-invalid");
        ...
        if(flag == 1){
            ...
            $.ajax({
                url: 'application/controller/admin/complaints.php',
                type: 'POST',
                data: formData,
                dataType: "json",
                success: function (data) {
