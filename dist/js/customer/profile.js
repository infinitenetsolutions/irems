$(function(){
    ...
    //         $.ajax({
    //             url: '../application/controller/customer/profile.php',
    //             type: 'POST',
    //             data: formData,
    //             dataType: "json",
    //             success: function (data) {
    ...
    $('form#editForm').submit(function (event) {
        ...
        if($("#editparentname").val() == ""){
            $("#editparentname").addClass("is-invalid");
            flag = 0;
        }else
            $("#editparentname").removeClass("is-invalid");
        if($("#editemailId").val() == ""){
            $("#editemailId").addClass("is-invalid");
            flag = 0;
        }else
            $("#editemailId").removeClass("is-invalid");
        ...
        if($("#editemailId").val() == ""){
         ...
         if($("#editpermanentaddress").val() == ""){
            $("#editpermanentaddress").addClass("is-invalid");
            flag = 0;
        }else
            $("#editpermanentaddress").removeClass("is-invalid");
            if($("#editcorrespondenceaddress").val() == ""){
            $("#editcorrespondenceaddress").addClass("is-invalid");
            flag = 0;
        }else
            $("#editcorrespondenceaddress").removeClass("is-invalid");
        if(flag == 1){
