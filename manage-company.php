...
<head>
    ...
    <title><?php if($setting->setting_firm_info->firm_nick_name != "") echo $setting->setting_firm_info->firm_nick_name; else echo $setting->setting_firm_info->firm_name; ?> | Company Management</title>
    <!-- Css Section Start -->
...
<body class="hold-transition sidebar-mini sidebar layout-fixed layout-navbar-fixed text-sm accent-navy pace-red">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="companyContactNumber" name="companyContactNumber" placeholder="Contact Number">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="companyGSTIN">GST IN</label>
                                                <input type="text" class="form-control" id="companyGSTIN" name="companyGSTIN" placeholder="GST IN">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="companyPincode" name="companyPincode" placeholder="Pincode">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
    ...
    <script src="dist/js/admin/manage-company.js"></script>
    <!-- Js Section End -->
</body>
