...
<head>
    ...
    <title><?php if($setting->setting_firm_info->firm_nick_name != "") echo $setting->setting_firm_info->firm_nick_name; else echo $setting->setting_firm_info->firm_name; ?> | Category Management</title>
    <!-- Css Section Start -->
...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed text-sm accent-navy pace-red">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Manage Item Category</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <form id="addForm" method="POST" enctype="multipart/form-data">
                    <div class="modal-content">
                            ...
                            <div class="card card-navy card-outline">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="categoryContactNumber">Category Description</label>
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <button type="submit" id="addButton" class="add-button btn btn-success btn-sm"><i class="fa fa-plus fa-sm"></i> Add Category</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script src="dist/js/admin/manage-category.js"></script>
    <!-- Js Section End -->
</body>
